...
function Pattern(source, formatCharacters, placeholderChar) {
  ...
  this.placeholderChar = placeholderChar === '' ? placeholderChar : (placeholderChar || DEFAULT_PLACEHOLDER_CHAR)
...
function InputMask(options) {
  ...
  if (options.placeholderChar.length > 1) {
    throw new Error('InputMask: placeholderChar should be a single character or blank')
  }
